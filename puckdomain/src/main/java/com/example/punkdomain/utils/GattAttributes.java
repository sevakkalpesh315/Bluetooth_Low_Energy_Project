...
public class GattAttributes {
    ...
    public  static String CLIENT_CHARACTERISTIC_CONFIG_DESCRIPTOR_UUID_PUCK_INTERFACE = String.format("00002902-74d6-43f8-a4fb-67c98b9ed30e");

    public static final String UUID_MASK = "0000%s-0000-1000-8000-00805f9b34fb";

    public static final String UUID_MASK_READ = "0000%s-74d6-43f8-a4fb-67c98b9ed30e";

      /*READ Type Characteristics*/
      public  static UUID CONNECTION_STATUS_CHARACTERISTIC1 = UUID.fromString("000001003-74d6-43f8-a4fb-67c98b9ed30e");

    /**
     * BLE Characteristics
     The BLE publishes four services: Puck Interface, User Data, Battery, and Device Information.
     The UUIDs of services and GUIDs of characteristics are defined in this document.
     Those which provide standard services and characteristics use UUIDs and GUIDs from the Bluetooth standard.
     */
    /*bytes = 1*/
    public  static String UUID_ERROR_CHARACTERISTIC = String.format(UUID_MASK_READ, "1002");
    /*bytes = 1*/
    public  static String CONNECTION_STATUS_CHARACTERISTIC =  String.format(UUID_MASK_READ, "1003");
    /*bytes = variable*/
    public  static String DEVICE_LIST_CHARACTERISTIC =  String.format(UUID_MASK_READ, "1005");
    /*bytes = variable*/
    public  static String SESSION_LIST_CHARACTERISTIC =  String.format(UUID_MASK_READ, "1008");
    /*bytes = variable*/
    public  static String DATA_CHARACTERISTIC =  String.format(UUID_MASK_READ, "100b");
    /*bytes = 1*/
    public  static String SLAVE_BATTERY_LEVEL_CHARACTERISTIC =  String.format(UUID_MASK_READ, "100c");
    /*bytes = 4*/
    public  static String SLAVE_FIRMWARE_REVISION_CHARACTERISTIC =  String.format(UUID_MASK_READ, "100d");
    /*bytes = 4*/
    public  static String MEMORY_CHARACTERISTIC = String.format(UUID_MASK_READ, "100e");
    /*bytes = 1*/
    public  static String RSSI_CHARACTERISTIC =  String.format(UUID_MASK_READ, "100f");
    /*bytes = variable*/
    public  static String IN_SESSIONDATA_CHARACTERISTIC =  String.format(UUID_MASK_READ, "1010");
    /*bytes = variable*/
    public  static String TRIGGER_DATA_CHARACTERISTIC =  String.format(UUID_MASK_READ, "1011");



    /*WRITE Type Characteristics*/
    /*bytes = 1*/
    public  static String COMMAND_CHARACTERISTIC = String.format(UUID_MASK_READ, "1001");
    /*bytes = variable*/
    public  static String CONFIG_DATA_CHARACTERISTIC = String.format(UUID_MASK_READ, "1004");
    /*bytes = 1*/
    public  static String DEVICE_ID_CHARACTERISTIC = String.format(UUID_MASK_READ, "1006");
    /*bytes = 6*/
    public  static String DEVICE_PIN_CHARACTERISTIC = String.format(UUID_MASK_READ, "1007");
    /*bytes = 2*/
    public  static String SESSION_ID_CHARACTERISTIC = String.format(UUID_MASK_READ, "1009");
    /*bytes = 1*/
    public  static String DATA_ID_CHARACTERISTIC = String.format(UUID_MASK_READ, "100a");
 ...
 * */
        ...
        attributes.put(CLIENT_CHARACTERISTIC_CONFIG_DESCRIPTOR_UUID_PUCK_INTERFACE               , "PUCK_INTERFACE ");

        attributes.put(COMMAND_CHARACTERISTIC               , "COMMAND_CHARACTERISTIC ");
        attributes.put(CONFIG_DATA_CHARACTERISTIC               , "CONFIG_DATA_CHARACTERISTIC");
        attributes.put(DEVICE_ID_CHARACTERISTIC               , "DEVICE_ID_CHARACTERISTIC");
        attributes.put(DEVICE_PIN_CHARACTERISTIC               , "DEVICE_PIN_CHARACTERISTIC");
        attributes.put(SESSION_ID_CHARACTERISTIC               , "SESSION_ID_CHARACTERISTIC");
        attributes.put(DATA_ID_CHARACTERISTIC               , "DATA_ID_CHARACTERISTIC");
        attributes.put(UUID_ERROR_CHARACTERISTIC               , "UUID_ERROR_CHARACTERISTIC");
        attributes.put(CONNECTION_STATUS_CHARACTERISTIC               , "CONNECTION_STATUS_CHARACTERISTIC");
        attributes.put(DEVICE_LIST_CHARACTERISTIC               , "DEVICE_LIST_CHARACTERISTIC");



        attributes.put(SESSION_LIST_CHARACTERISTIC               , "SESSION_LIST_CHARACTERISTIC ");
        attributes.put(DATA_CHARACTERISTIC               , "DATA_CHARACTERISTIC");
        attributes.put(SLAVE_BATTERY_LEVEL_CHARACTERISTIC               , "SLAVE_BATTERY_LEVEL_CHARACTERISTIC");
        attributes.put(SLAVE_FIRMWARE_REVISION_CHARACTERISTIC               , "SLAVE_FIRMWARE_REVISION_CHARACTERISTIC");
        attributes.put(MEMORY_CHARACTERISTIC               , "MEMORY_CHARACTERISTIC");
        attributes.put(DATA_ID_CHARACTERISTIC               , "DATA_ID_CHARACTERISTIC");
        attributes.put(RSSI_CHARACTERISTIC               , "RSSI_CHARACTERISTIC");
        attributes.put(IN_SESSIONDATA_CHARACTERISTIC               , "INSESSIONDATA_CHARACTERISTIC");
        attributes.put(TRIGGER_DATA_CHARACTERISTIC               , "TRIGGER_DATA_CHARACTERISTIC");
